...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([sectionName isEqualToString:@"Setting"]) {
        if ([@"Push Notification" isEqualToString:cellName]) {
            ...
            [parameters setObject:[JpDataUtil getDicFromUDByKey:KEY_USER_ID] forKey:@"userId"];
        ...
        if ([@"Logout" isEqualToString:cellName]) {
            [JpDataUtil saveDataToUDForKey:KEY_USER_ID value:@""];
            [JpDataUtil saveDataToUDForKey:KEY_USER_CD value:@""];
            [JpDataUtil saveDataToUDForKey:KEY_USER_NAME value:@""];
